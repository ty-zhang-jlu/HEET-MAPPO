...
def get_config():
    ...
    # prepare parameters
    parser.add_argument("--algorithm_name", type=str, default="matd3", choices=[
    ...
    parser.add_argument('--num_env_steps', type=int,
                        default=20000, help="Number of env steps to train for")
    ...
    # env parameters
    parser.add_argument('--env_name', type=str, default="UAT-MTT")
    ...
    parser.add_argument('--layer_N', type=int, default=5,
    ...
    # rmatd3 parameters
    parser.add_argument("--target_action_noise_std", default=0.5, help="Target action smoothing noise for matd3")
    # rmasac parameters
    parser.add_argument('--alpha', type=float, default=1.0,
                        help="Initial temperature")
    parser.add_argument('--target_entropy_coef', type=float,
                        default=0.01, help="Initial temperature")
    ...
    parser.add_argument('--num_random_episodes', type=int, default=2,
    ...
    parser.add_argument('--epsilon_anneal_time', type=int, default=5000,
    ...
    parser.add_argument('--eval_interval', type=int,  default=7500,
