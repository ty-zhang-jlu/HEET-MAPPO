...
def get_config():
    ...
    parser.add_argument("--action_dims", type=dict, default=[2, 40, 1], help="智能体的动作维度（自动计算）")
    ...
    parser.add_argument("--epsilon", type=float, default=0.01, help="greedy exploitation")
    ...
    parser.add_argument("--history_length", type=int, default=5, help="length for history entropy")
    # ppo parameters
    parser.add_argument("--ppo_epoch", type=int, default=20, help="number of ppo epochs (default: 15)")
    parser.add_argument("--_C_sigema", type=float, default=1, help="value about coef and lr")
    parser.add_argument("--_kesai", type=float, default=0.1, help="critic net estimate error")
    parser.add_argument("--_param_noise_std", type=float, default=0.01, help="critic noise")
    parser.add_argument("--_use_param_noise", action="store_true", default=True, help="whether critic noise")
    parser.add_argument(
        "--use_clipped_value_loss",
        action="store_false",
        default=True,
