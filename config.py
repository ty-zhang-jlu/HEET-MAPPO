...
def get_config():
    ...
    parser.add_argument("--num_agents", type=int, default=17, help="number of players")
    parser.add_argument("--algorithm_name", type=str, default="rmappo", choices=["rmappo", "mappo"])
    parser.add_argument("--action_dims", type=dict, default=[2, 40], help="智能体的动作维度（自动计算）")
    ...
    parser.add_argument("--n_rollout_threads", type=int, default=2, help="Number of parallel envs for training rollouts")
    parser.add_argument("--n_eval_rollout_threads", type=int, default=2, help="Number of parallel envs for evaluating rollouts")
    parser.add_argument("--n_render_rollout_threads", type=int, default=2, help="Number of parallel envs for rendering rollouts")
    parser.add_argument("--num_env_steps", type=int, default=6e5, help="Number of environment steps to train (default: 10e6)")
    ...
    parser.add_argument("--hidden_size", type=int, default=256, help="Dimension of hidden layers for actor/critic networks")
    ...
    parser.add_argument("--critic_lr", type=float, default=0.0001, help="critic learning rate (default: 5e-4)")
    ...
    parser.add_argument("--num_mini_batch", type=int, default=8, help="number of batches for ppo (default: 1)")
    ...
    parser.add_argument("--eval_interval", type=int, default=25, help="time duration between continuous twice evaluation progress.")
