...
from global_mappo_8.utils.util import get_gard_norm, huber_loss, mse_loss
from global_mappo_8.utils.valuenorm import ValueNorm
from global_mappo_8.algorithms.utils.util import check
...
class RMAPPO():
    ...
    def ppo_update(self, sample, vary_L, vary_noise, beta_t, update_actor=True):
        ...
        # print('重要性采样结果：', imp_weights_1, imp_weights_2, imp_weights_3)
        # 计算策略损失
        #10 ** 14 *, 0.1 *, + (1 - beta_t) * ers_1, + (1 - beta_t) * ers_2,  + (1 - beta_t) * ers_3
        ...
        # print('clip之前：', surr1_1, surr2_1, surr3_1)
        ...
        # print('clip之后：', policy_loss, policy_loss_2, policy_loss_3)
