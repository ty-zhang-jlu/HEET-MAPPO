...
from global_mappo_1.config import get_config
from global_mappo_1.envs.env_wrappers import DummyVecEnv


def make_train_env(all_args):
    def get_env_fn(rank):
        def init_env():
            from global_mappo_1.envs.env_continuous import ContinuousActionEnv
...
def main(args):
    ...
    if all_args.share_policy:
        from global_mappo_1.runner.shared.env_runner import EnvRunner as Runner
