...
class SharedReplayBuffer(object):
    ...
    def __init__(self, args, num_agents, obs_space, cent_obs_space, act_space):
        ...
        self.entropies = np.zeros((self.episode_length, self.n_rollout_threads, num_agents-1, 1), dtype=np.float32)
    ...
    def insert(self, share_obs, obs, rnn_states_actor, rnn_states_actor_BS, rnn_states_actor_MBS, rnn_states_critic, actions, actions_BS, actions_MBS,
               ...
               value_preds_exploit=None, bad_masks=None, active_masks=None, available_actions=None, entropies=None):
        ...
        if entropies is not None:
            self.entropies[self.step] = entropies.copy()
